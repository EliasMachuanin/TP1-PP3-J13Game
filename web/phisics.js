...
r1 = Rectangle(Vec2(500, 100), 700, 20, 0, 1, .5);

r2= Rectangle(Vec2(500, 500), 700, 20, 0, 1, .5);

r3= Rectangle(Vec2(150, 300), 20, 500, 0, 1, .5);

r4= Rectangle(Vec2(850, 300), 20, 500, 0, 1, .5);
...
r = Circle(Vec2(200, 150),  30,0.5, 1, .5);


//meta
puerta = Rectangle(Vec2(800, 450), 50, 80, 0, 1, .5);
